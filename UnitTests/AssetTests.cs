...
namespace UnitTests
{
    ...
    public class AssetTests
    {
        ...
        public void InitiateAsset()
        {
            ...
            _assetController.AddField(new Field("Label of first field", "content of first field", Field.FieldType.TextBox, "Default value of first field"));
            _assetController.AddField(new Field("Label of second field", "content of second field", Field.FieldType.Checkbox, "Default value of second field"));
        }
