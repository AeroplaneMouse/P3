...
INSERT INTO assets (id, name, identifier, description, options, department_id, updated_at) VALUES
    ...
    (6, 'Logitech MX Master', 'LOG-MUS-MXMASTER', 'Arbejd hurtigere med den trådløse Logitech MX Master 3 mus. Sensoren registrerer enhver overflade, knapper kan kortlægges, så de åbner dine yndlingsapps, MagSpeed-hjulet kører hurtigt gennem dine dokumenter og signalet er stadig stærkt 10 meter væk.', '[]', 1, current_timestamp);
    (7, 'Lenovo T590','T590-ID-15972','Med en startvægt på kun 1,75 kg er 15,6" ThinkPad T590 et fremragende mobilt arbejdsredskab. Den har forskellige skærmmuligheder, f.eks. FHD-touchskærm og 4K Dolby Vision®. Desuden har den en række produktivitetsværktøjer som f.eks. to langtrækkende, støjannullerende mikrofoner, lang batteridriftstid og mulighed for global LTE-A-forbindelse. Hvis forretningsverdenen er din arbejdsplads, er denne bærbare pc lige noget for dig.','[]',1,current_timestamp)
    (8, 'Lenovo T590','T590-ID-15973','Med en startvægt på kun 1,75 kg er 15,6" ThinkPad T590 et fremragende mobilt arbejdsredskab. Den har forskellige skærmmuligheder, f.eks. FHD-touchskærm og 4K Dolby Vision®. Desuden har den en række produktivitetsværktøjer som f.eks. to langtrækkende, støjannullerende mikrofoner, lang batteridriftstid og mulighed for global LTE-A-forbindelse. Hvis forretningsverdenen er din arbejdsplads, er denne bærbare pc lige noget for dig.','[]',1,current_timestamp)
    (9, 'Lenovo T590','T590-ID-15992','Med en startvægt på kun 1,75 kg er 15,6" ThinkPad T590 et fremragende mobilt arbejdsredskab. Den har forskellige skærmmuligheder, f.eks. FHD-touchskærm og 4K Dolby Vision®. Desuden har den en række produktivitetsværktøjer som f.eks. to langtrækkende, støjannullerende mikrofoner, lang batteridriftstid og mulighed for global LTE-A-forbindelse. Hvis forretningsverdenen er din arbejdsplads, er denne bærbare pc lige noget for dig.','[]',1,current_timestamp)
