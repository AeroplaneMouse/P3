...
namespace AMS.ViewModels
{
    public class MainViewModel : Base.BaseViewModel
    {
        ...
        public MainViewModel(Window window)
        {
            ...
            ShowAssetListPageCommand = new Base.RelayCommand(() => ContentFrame.Navigate(new AssetList(this, new AssetRepository(), new PrintHelper(), new CommentController(CurrentSession, new CommentRepository()))));
